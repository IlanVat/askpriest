...
export const HowItWorks = () => {
  ...
  return <section ref={sectionRef} className="py-20 bg-white opacity-0">
      <div className="container">
        <h2 className="text-3xl md:text-4xl font-serif text-center mb-12">How AskPriestAI Works</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => <div key={step.title} className="flex flex-col items-center text-center p-6 opacity-0 animate-scrollReveal" style={{
