...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "New users can ask up to 10 questions per month for free. After that, continue your spiritual journey for as low as $9.99/month or save up to 30% with an annual plan. There's no credit card required to start with the free questions.",
      icon: Info,
    },
    {
